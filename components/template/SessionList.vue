    ...
    data() {
      return {
        ...
        halla: [
            ...
            { time: '13:20-13:50',session:'特別ゲスト', title:'(タイトル未定)' , name: 'ハヤカワ五味', post: '株式会社ウツワ代表取締役／起業家',display: 'contents' },
            ...
            { time: '16:05-16:35',session:'session4-1',title:'(タイトル未定)', name: '中村寛子', post: 'MASHING UP プロデューサー',display:'contents' },
